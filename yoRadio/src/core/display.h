...
class Display {
  public:
    ...
    displayMode_e _mode,_mode_back;
  public:
    Display() {};
  ...
  private:
    ...
    ClockWidget _clock;
    Page *_boot;
    TextWidget *_bootstring, *_volip, *_voltxt, *_rssi, *_rssitxt,*_bitrate, *_bt, *_bat, *_battxt;
    Ticker _returnTicker, _chargeTicker;
    uint8_t _bootStep;
    charge_t charge;
    ...
    void _setReturnBackTicker(uint8_t time_s);
    void _layoutChange(bool played);
    void _setRSSI(int rssi);
    void _showFavWarn(uint8_t id);
    void _set_bt(bool s);
